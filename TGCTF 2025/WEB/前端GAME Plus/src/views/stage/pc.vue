<template>
  <div class="container">
    <div v-show="flag" class="welcome">
      ...
      <el-button class="change-btn" type="primary" @click="handleStart">开始游戏</el-button>
    </div>
    <div class="score">{{ score }}分</div>
    <div class="stage">
      <div v-for="item in data" :style="{
    ...
    <el-button class="change-btn" type="primary" @click="handleOver">结束游戏</el-button>
  </div>
</template>
...
const handleOver = () => {
  ...
  ElMessageBox.alert(result(score.value), "雪糕消消大作战", {
